...
class _CalculatorState extends State<Calculator> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text('Kalkulator-fin'), backgroundColor: Colors.black,),
          ...
          // Tampilan Calculator
            ...
            Row(
              ...
              children: [
                ...
                calcbutton('x', Colors.blueGrey, Colors.black),
              ],
            ),
            SizedBox(height: 10,),
            Row(
            ...
            Row(
              ...
              children: [
                // Button 0
                RaisedButton(
                  padding: EdgeInsets.fromLTRB(35, 20, 153, 20),
                  onPressed: (){
                    // Fungsi Button
                  },
                  shape: StadiumBorder(),
